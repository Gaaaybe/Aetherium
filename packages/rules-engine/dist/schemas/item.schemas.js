...
export function calculateItemBaseValue(custoBase, nivelItem) {
    return custoBase * nivelItem;
}
export function calculateItemSellPrice(custoBase, nivelItem) {
    return Math.floor(calculateItemBaseValue(custoBase, nivelItem) / 2);
}
export function scaleWeaponDie(dado, upgradeLevelValue) {
